...
SUITE["eternity"]["5x5_opt_rei"] = @benchmarkable solve_eternity("eternity_5x5"; height=5, width=5, optimize=true, reified=true) seconds=120
...
SUITE["graph_coloring"]["lee450_5d"] = @benchmarkable color_graph("benchmark/graph_color/data/lee450_5d.col", 7) seconds=10

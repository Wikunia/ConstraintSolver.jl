...
@testset "Logs"  begin
    ...
    bt_infeasible = Int[]
    feasible = 0
    l1 = CS.TreeLogNode(0,:Open,0,0,0,0,var_states, var_changes, children, bt_infeasible, feasible, Int[]) 
    l2 = CS.TreeLogNode(0,:Closed,0,0,0,0,var_states, var_changes, children, bt_infeasible, feasible, Int[]) 
    ...
    push!(children, tln1)
    push!(children, tln2)
    l1 = CS.TreeLogNode(0,:Closed,0,0,0,0,var_states, var_changes, children[[1,2]], bt_infeasible, feasible, Int[]) 
    l2 = CS.TreeLogNode(0,:Closed,0,0,0,0,var_states, var_changes, children[[2,1]], bt_infeasible, feasible, Int[])
    @test !CS.same_logs(l1,l2) 
    ...
    push!(children, tln2)
    l1 = CS.TreeLogNode(0,:Closed,0,0,0,0,var_states, var_changes, children[[1,2]], bt_infeasible, feasible, Int[])
    l2 = CS.TreeLogNode(0,:Closed,0,0,0,0,var_states, var_changes, children[[1]], bt_infeasible, feasible, Int[])
    @test !CS.same_logs(l1,l2) 
    ...
    l1 = CS.TreeLogNode(0,:Closed,0,0,0,0,var_states, var_changes, children1, bt_infeasible, feasible, Int[]) 
    l2 = CS.TreeLogNode(0,:Closed,0,0,0,0,var_states, var_changes, children2, bt_infeasible, feasible, Int[])
    @test !CS.same_logs(l1,l2)

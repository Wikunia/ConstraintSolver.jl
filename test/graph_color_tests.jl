...
@testset "49 US states + DC" begin
    ...
    num_colors = 8
    washington = CS.addVar!(com, 1, num_colors)
    montana = CS.addVar!(com, 1, num_colors)
    maine = CS.addVar!(com, 1, num_colors)
    north_dakota = CS.addVar!(com, 1, num_colors)
    south_dakota = CS.addVar!(com, 1, num_colors)
    wyoming = CS.addVar!(com, 1, num_colors)
    wisconsin = CS.addVar!(com, 1, num_colors)
    idaho = CS.addVar!(com, 1, num_colors)
    vermont = CS.addVar!(com, 1, num_colors)
    minnesota = CS.addVar!(com, 1, num_colors)
    oregon = CS.addVar!(com, 1, num_colors)
    new_hampshire = CS.addVar!(com, 1, num_colors)
    iowa = CS.addVar!(com, 1, num_colors)
    massachusetts = CS.addVar!(com, 1, num_colors)
    nebraska = CS.addVar!(com, 1, num_colors)
    new_york = CS.addVar!(com, 1, num_colors)
    pennsylvania = CS.addVar!(com, 1, num_colors)
    connecticut = CS.addVar!(com, 1, num_colors)
    rhode_island = CS.addVar!(com, 1, num_colors)
    new_jersey = CS.addVar!(com, 1, num_colors)
    indiana = CS.addVar!(com, 1, num_colors)
    nevada = CS.addVar!(com, 1, num_colors)
    utah = CS.addVar!(com, 1, num_colors)
    california = CS.addVar!(com, 1, num_colors)
    ohio = CS.addVar!(com, 1, num_colors)
    illinois = CS.addVar!(com, 1, num_colors)
    washington_dc = CS.addVar!(com, 1, num_colors)
    delaware = CS.addVar!(com, 1, num_colors)
    west_virginia = CS.addVar!(com, 1, num_colors)
    maryland = CS.addVar!(com, 1, num_colors)
    colorado = CS.addVar!(com, 1, num_colors)
    kentucky = CS.addVar!(com, 1, num_colors)
    kansas = CS.addVar!(com, 1, num_colors)
    virginia = CS.addVar!(com, 1, num_colors)
    missouri = CS.addVar!(com, 1, num_colors)
    arizona = CS.addVar!(com, 1, num_colors)
    oklahoma = CS.addVar!(com, 1, num_colors)
    north_carolina = CS.addVar!(com, 1, num_colors)
    tennessee = CS.addVar!(com, 1, num_colors)
    texas = CS.addVar!(com, 1, num_colors)
    new_mexico = CS.addVar!(com, 1, num_colors)
    alabama = CS.addVar!(com, 1, num_colors)
    mississippi = CS.addVar!(com, 1, num_colors)
    georgia = CS.addVar!(com, 1, num_colors)
    south_carolina = CS.addVar!(com, 1, num_colors)
    arkansas = CS.addVar!(com, 1, num_colors)
    louisiana = CS.addVar!(com, 1, num_colors)
    florida = CS.addVar!(com, 1, num_colors)
    michigan = CS.addVar!(com, 1, num_colors)

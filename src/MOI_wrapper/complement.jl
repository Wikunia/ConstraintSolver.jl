...
function JuMP.parse_constraint_call(_error::Function, vectorized::Bool, ::Val{:!}, constraint)
    ...
    vectorized, inner_parsecode, inner_buildcall = JuMP.parse_constraint(_error1, constraint)
